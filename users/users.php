...
function validateUser($user, &$errors){
  ...
  if(!$user['username'] || strlen($user['username']) < 3 || strlen($user['username']) > 16){
    $isValid = false;
    $errors['username'] = "Username is required and it must be more than 3 and less then 16 character";
  }
